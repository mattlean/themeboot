...
<head>
	...
	<title>Project M Rankings | Santa Cruz Fighting Game Community</title>
...
<body>
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown active">
								...
								<ul class="dropdown-menu" role="menu">
									<li class="active"><a href="/rankings/pm.php">Project M</a></li>
	...
	<div class="banner">
		<div class="item banner-ssbm-rank">
			<div class="container">
				<h1 class="page-title">Project M Rankings</h1>
			</div>
		</div>
	</div>
	<div class="container content blog">
		...
		<p class="text-center">
			View brackets: <a href="http://scfgc.challonge.com/pm_ranked_night_2" target="_blank">#2</a>, <a href="http://scfgc.challonge.com/pm_ranked_night_4" target="_blank">#4</a>, <a href="http://scfgc.challonge.com/pm_ranked_night_7" target="_blank">#7</a>
		</p>
		<?php include("rs_display/rs_display_script.php") ?>
		<?php
		display_season_results(3);
		?>
